...
def execute_process(args):
    ...
    print('loop')
    print("frida  -l ./tmp/hook_{}_{}p.js -f  ./threads '{}' < tmp/test_{}_{}.txt  > tmp/a_{}_{}".format(ch,  j,ploadinp,ch,  j,ch,  j))
    data  = system("frida  -l ./tmp/hook_{}_{}p.js -f  ./threads '{}' < tmp/test_{}_{}.txt  > tmp/a_{}_{}".format(ch,  j,ploadinp,ch, j,ch,  j))
    kotak = []
